...
Pulls the official launch date and client metadata from a Salesforce-like source.
Reviews Asana-like tasks, milestones, owners, dependencies, and overdue work.
Reviews Slack-like messages for blockers, delays, unresolved dependencies, and client/vendor issues.
Checks Calendar-like events for required implementation milestones.
Applies deterministic risk rules.
Adds lightweight natural-language signal detection for unstructured Slack messages.
Produces:
